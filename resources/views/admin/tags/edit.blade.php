...
@section('title', __('admin.tags_edit'))
@section('breadcrumb') <a href="{{ route('admin.tags.index') }}">{{ __('admin.nav_tags') }}</a> <span class="sep">›</span> {{ __('admin.btn_edit') }} @endsection
@section('content')
...
<div class="card">
  <div class="card-body">
    ...
    <div class="form-group">
      <label class="form-check"><input type="checkbox" name="status" value="1" {{ $tag->status?'checked':'' }}> {{ __('admin.label_active_tag') }}</label>
    </div>
